...
const instanceCreateUrl = "/api/instanceCreate"
  ...
  <el-form label-width="auto">
    ...
    <el-row>
      ...
      <el-col :span="7" :offset="1">
        <el-form-item label="MilvusPassWord">
          <el-input v-model="milvusInstanceStore.milvusInstance.MilvusServerPassWord" placeholder="skip if no authentication" type="password" autocomplete="off"/>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
    ...
    <el-row>
      ...
      <el-col :span="7" :offset="1">
        <el-form-item label="MilvusMetricType">
          <el-select v-model="milvusInstanceStore.milvusInstance.MilvusMetricType" placeholder="please select metricType">
    ...
    <el-row>
      ...
      <el-col :span="2" :offset="1">
        <a href="https://bailian.console.aliyun.com/?tab=api#/api/?type=model&url=https%3A%2F%2Fhelp.aliyun.com%2Fdocument_detail%2F2712195.html&renderType=iframe" target="_blank">
          获取
        </a>
      </el-col>
    </el-row>
