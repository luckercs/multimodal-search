    ...
    <el-row>
      <el-col :span="7">
        <el-form-item label="MilvusServerIp">
          <el-input
            v-model="milvusInstanceStore.milvusInstance.MilvusServerName"
      ...
      <el-col :span="7" :offset="1">
        <el-form-item label="MilvusServerPort">
          <el-input
            v-model="milvusInstanceStore.milvusInstance.MilvusServerPort"
            placeholder="19530"
          />
        </el-form-item>
      </el-col>
    ...
    <el-row>
      <el-col :span="7">
        <el-form-item label="MilvusUserName">
          <el-input
            v-model="milvusInstanceStore.milvusInstance.MilvusServerUserName"
            placeholder="root"
          />
        </el-form-item>
      </el-col>
      <el-col :span="7" :offset="1">
        <el-form-item label="MilvusPassWord">
          <el-input
            v-model="milvusInstanceStore.milvusInstance.MilvusServerPassWord"
            placeholder="skip if no authentication"
            type="password"
            autocomplete="off"
          />
        </el-form-item>
    ...
    <el-row>
      <el-col :span="7">
        <el-form-item label="Milvus集合实例名称">
          <el-input
            v-model="milvusInstanceStore.milvusInstance.MilvusCollectionName"
            placeholder="imageserch_1"
          />
        </el-form-item>
      </el-col>
    </el-row>
    <el-row>
      <el-col :span="7">
        <el-form-item label="MilvusIndexName">
          <el-select
            v-model="milvusInstanceStore.milvusInstance.MilvusIndexName"
            placeholder="please select indexName"
          >
      ...
      <el-col :span="7" :offset="1">
        <el-form-item label="MilvusMetricType">
          <el-select
            v-model="milvusInstanceStore.milvusInstance.MilvusMetricType"
    ...
    <el-row>
      <el-col :span="7">
        <el-form-item label="Model_API_KEY">
          <el-input
            v-model="milvusInstanceStore.milvusInstance.Model_API_KEY"
            type="password"
            autocomplete="off"
          />
        </el-form-item>
      ...
      <el-col :span="2" :offset="1">
        ...
        <a
          href="https://bailian.console.aliyun.com/?tab=api#/api/?type=model&url=https%3A%2F%2Fhelp.aliyun.com%2Fdocument_detail%2F2712195.html&renderType=iframe"
          target="_blank"
        >
          获取
        </a>
